...
public class Box2dBall {
    ...
    void applyForce() {
        ...
        if (this.mBody.getPosition().x > Constants.SCREEN_WIDTH / 2 - .78f) {
            this.mBody.setLinearVelocity(this.mBody.getLinearVelocity().x * 0.01F, this.mBody.getLinearVelocity().y * 0.01F);
        }

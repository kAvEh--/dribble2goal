...
public class ImageAccessor implements TweenAccessor<Image> {
    ...
    public int getValues(Image paramImage, int paramInt, float[] paramArrayOfFloat) {
        switch (paramInt) {
            case 7:
    ...
    public void setValues(Image paramImage, int paramInt, float[] paramArrayOfFloat) {
        switch (paramInt) {
            case 7:
            ...
            case 1:
                ...
                return;
            case 2:
                paramImage.setWidth(paramArrayOfFloat[0]);
                paramImage.setHeight(paramArrayOfFloat[1]);
                paramImage.setOriginX(paramArrayOfFloat[2]);
                paramImage.setOriginY(paramArrayOfFloat[3]);
                return;
            case 3:
            ...
            case 4:
                paramImage.setX(paramArrayOfFloat[0]);
                paramImage.setY(paramArrayOfFloat[1]);
                paramImage.setWidth(paramArrayOfFloat[2]);
                paramImage.setHeight(paramArrayOfFloat[3]);
                return;
            case 5:
                paramImage.setWidth(paramArrayOfFloat[0]);
                paramImage.setHeight(paramArrayOfFloat[1]);
